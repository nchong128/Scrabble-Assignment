...
while True:
    ...
    elif letterCheck(chosenWord) and dictionaryCheck(chosenWord) and tileCheck(chosenWord):
        if locationPlaceCheck(chosenWord,wordLocation) and locationSyntaxCheck(chosenWord,wordLocation):
